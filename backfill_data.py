...
def backfill_data(start_date: str, end_date: str, ts_codes: list = None, data_type: str = 'daily'):
    """
    一个更强大的数据回填工具。
    ...
    for i, code in enumerate(ts_codes):
        try:
            if data_type == 'daily':
                ...
                dm.get_adjusted_daily(ts_code=code, start_date=start_date, end_date=end_date)
            # 未来可以扩展其他数据类型
...
if __name__ == '__main__':
    ...
    parser.add_argument('--stocks', nargs='*', default=None, help="股票代码列表，不填则为全市场")
